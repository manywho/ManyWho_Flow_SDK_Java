...
public interface WritableDatabase<C extends Configuration, T> {
     ...
     * @param objectDataType information about the type of object that is being handled by the service
     * @param object         the populated ManyWho object to create in the store
     * @return a typed ManyWho object populated with an ID
     */
    T create(C configuration, ObjectDataType objectDataType, T object);
     ...
     */
    List<T> create(C configuration, ObjectDataType objectDataType, List<T> objects);
     ...
     */
    void delete(C configuration, ObjectDataType objectDataType, T object);
     ...
     */
    void delete(C configuration, ObjectDataType objectDataType, List<T> objects);
     ...
     */
    T update(C configuration, ObjectDataType objectDataType, T object);
     ...
     */
    List<T> update(C configuration, ObjectDataType objectDataType, List<T> objects);
}
