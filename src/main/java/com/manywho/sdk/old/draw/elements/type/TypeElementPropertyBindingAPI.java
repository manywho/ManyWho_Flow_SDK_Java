package com.manywho.sdk.old.draw.elements.type;
...
public class TypeElementPropertyBindingAPI extends JSONObject implements Serializable
{
	...
	private String privatedatabaseFieldName;
	public final String getDatabaseFieldName()
	{
		return privatedatabaseFieldName;
	}
	public final void setDatabaseFieldName(String value)
	{
		privatedatabaseFieldName = value;
	}
	...
	private String privatedatabaseContentType;
	public final String getDatabaseContentType()
	{
		return privatedatabaseContentType;
	}
	public final void setDatabaseContentType(String value)
	{
		privatedatabaseContentType = value;
	}
}