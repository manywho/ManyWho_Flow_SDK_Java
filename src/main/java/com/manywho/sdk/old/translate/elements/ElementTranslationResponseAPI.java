package com.manywho.sdk.old.translate.elements;
...
public class ElementTranslationResponseAPI extends JSONObject implements Serializable
{
	...
	private ContentValueDocumentAPI privatecontentValueDocument;
	public final ContentValueDocumentAPI getContentValueDocument()
	{
		return privatecontentValueDocument;
	}
	public final void setContentValueDocument(ContentValueDocumentAPI value)
	{
		privatecontentValueDocument = value;
	}
}